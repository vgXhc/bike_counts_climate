...
Next we create a set of hourly temperatures.

```{r}
# filter rows with duplicate temp entries
# (the latter is I believe from 24 h rows)
# create new date/time variable
# fix temperature units to degree Celsius
# for hours with more than 1 measurement, average between values
...
Looks good! You can see a bunch of missing values, and it may be worth
interpolating them. But we'll leave this as is for now. Next we turn to
precipitation.
